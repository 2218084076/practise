...
for url in urls:
    ...
    for i in range(0,len(l)):
        ...
        table.write(base_i+i,1,l[i].get("name","no name"))
        table.write(base_i+i,2,l[i].get("fan","no fan"))
        table.write(base_i+i,3,l[i].get("shop","no shop"))
        table.write(base_i+i,4,l[i].get("wechat","no wechat"))
        table.write(base_i+i,5,l[i].get("phone","no phone"))
        table.write(base_i+i,6,l[i].get("introduce","no introduce"))
        table.write(base_i+i,7,l[i].get("dou_id","no id"))
